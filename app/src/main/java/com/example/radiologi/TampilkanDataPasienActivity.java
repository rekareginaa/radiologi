...
*/
    ...
    protected PDFBody getBodyViews() {
        ...
        textSurat.setText("SURAT HASIL PEMERIKSAAN RADIOLOGI");
        ...
        text1.getView().setPadding(10, 20, 0, 0);
        ...
        text2.setText("Nomor Rekam Medik");
        text2.getView().setGravity(Gravity.LEFT);
        text2.getView().setPadding(10, 20, 0, 0);
        ...
        text3.setText("Nama Pasien");
        text3.getView().setGravity(Gravity.LEFT);
        text3.getView().setPadding(10, 10, 0, 0);
        ...
        namaPasien.setText(": Naruto Uzumaki");
        namaPasien.getView().setGravity(Gravity.LEFT);
        namaPasien.getView().setPadding(0, 10, 0, 0);
        namaPasien.setLayout(new LinearLayout.LayoutParams(
                0,
                ViewGroup.LayoutParams.WRAP_CONTENT, 4));
        horizontalView1.addView(namaPasien);
        ...
        text4.setText("Tanggal Lahir");
        text4.getView().setGravity(Gravity.LEFT);
        text4.getView().setPadding(10, 10, 0, 0);
        ...
        tanggalLahir.setText(": ddmmyyyy");
        tanggalLahir.getView().setGravity(Gravity.LEFT);
        tanggalLahir.getView().setPadding(0, 10, 0, 0);
        tanggalLahir.setLayout(new LinearLayout.LayoutParams(
                0,
                ViewGroup.LayoutParams.WRAP_CONTENT, 4));
        horizontalView2.addView(tanggalLahir);
        ...
        text5.setText("Jenis Kelamin");
        text5.getView().setGravity(Gravity.LEFT);
        text5.getView().setPadding(10, 10, 0, 0);
        ...
        jenisKelamin.getView().setPadding(0, 10, 0, 0);
        jenisKelamin.setLayout(new LinearLayout.LayoutParams(
                0,
                ViewGroup.LayoutParams.WRAP_CONTENT, 4));
        horizontalView3.addView(jenisKelamin);
        ...
        text6.setText("Gambar");
        text6.getView().setGravity(Gravity.LEFT);
        text6.getView().setPadding(10, 10, 0, 0);
        ...
        gambarPemeriksaan.setText(": iii");
        gambarPemeriksaan.getView().setGravity(Gravity.LEFT);
        gambarPemeriksaan.getView().setPadding(0, 10, 0, 0);
...
//        PDFHorizontalView horizontalView5 = new PDFHorizontalView(getApplicationContext());
        ...
        text7.setText("Hasil Pemeriksaan");
        text7.getView().setPadding(10, 10, 0, 0);
